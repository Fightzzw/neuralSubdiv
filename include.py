...
# pygptoolbox
from torchgptoolbox_nosparse.readMESH import readMESH
from torchgptoolbox_nosparse.writeMESH import writeMESH
from torchgptoolbox_nosparse.findIdx import findIdx
...
def processTrainShapes(folder):
    ...
    for ii in range(nObjs):
        ...
        for jj in range(nSubd + 1):
            V, F = tgp.readMESH(paths[jj] + objFiles[ii] + '.obj')
